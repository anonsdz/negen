...
ADMIN_IDS = [7371969470, 123456789, 987654321, 192837465, 123123123, 456456456, 789789789, 135135135, 246246246, 357357357]  # Thêm 10 UID admin
GROUP_IDS = [-1002447120255, -1001111111111, -1002222222222, -1003333333333, -1004444444444, -1005555555555, -1006666666666, -1007777777777, -1008888888888, -1009999999999]  # Thêm 10 Group ID
...
async def help_command(update):
    ...
    /attack <method_name> <url> - Start an attack using a method.
...
def main():
    ...
    application.add_handler(CommandHandler('attack', lambda update, context: command_handler(update, context, attack_method, 2, "Invalid syntax for /attack command.")))
    application.add_handler(CommandHandler('list_methods', list_methods, pass_args=True))
